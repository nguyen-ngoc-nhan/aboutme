...
<head>
    ...
    <link href="/templates/admin/assets/css/index.css" rel="stylesheet" media="all">
    <!-- script-->
    <script src="/templates/admin/assets/js/scripts.js" type="text/javascript" charset="utf-8" async defer></script>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/templates/admin/assets/images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Ngọc nhân</h6>
                                                    <p>Bây giờ bạn đã kết nối trên tin nhắn</p>
                                                    <span class="time">Hôm nay</span>
                                                </div>
                                            </div>
                                            <div class="mess__footer">
                                                <a href="chat/index.php">Quản lý bình luận</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            <div class="email__title">
                                                <p>Bạn có 3 mail mới</p>
                                            </div>
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/templates/admin/assets/images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="/templates/admin/assets/images/icon/avatar-big-01.jpg" alt="Nhân Nguyễn" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Nhân nguyễn</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="/templates/admin/assets/images/icon/avatar-big-01.jpg" alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
